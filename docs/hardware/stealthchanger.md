...
!!! info "*MGN9/Micron"
    ...
    The Micron's belt path has a smaller spacing between the belts and requires the [MOD NAME](#) by AUTHOR.

!!! info "*9mm belts"
    9mm belts can be used with CNC Shuttles. If you want to use 9mm belts with a printed Shuttle, a [usermod by BT123](#){:target="_blank"} is required.
...
!!! info "Mini/Micro BFI"
    Due to the reduced length of [Mini/Micro BFI](#){:target="_blank"}, Belt Helper is required to pre tension your belts to a point where your idlers only need minimal adjustment.
